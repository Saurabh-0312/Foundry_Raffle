# the below make commands are copied for the course and since my vs code does not have makefile i ran the deploy with command given below:-
...
deploy:
	@forge script script/Deploy.s.sol:DeployRaffle $(NETWORK_ARGS)

createSubscription:
	@forge script script/interactions.s.sol:CreateSubscription $(NETWORK_ARGS)

addConsumer:
	@forge script script/interactions.s.sol:AddConsmer $(NETWORK_ARGS)
